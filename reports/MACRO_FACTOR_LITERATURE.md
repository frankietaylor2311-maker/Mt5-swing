...
| EPU risk gate | **boarded §76** | Baker–Bloom–Davis US EPU (USEPUINDXM) gate/cool on soft_ew_macro5; primary soft_low_epu; monthly z 60m; fixed z≥1 → scale 0.35 (§71–§75 symmetry) |
| TPU risk gate | **boarded §76** | Categorical Trade-policy TPU gate/cool on soft_ew_macro5; soft_low_tpu / soft_tpu_cool companions |
| EPU+TPU stack | **boarded §76** | Sequential EPU then TPU cool on soft (`soft_epu_tpu_stack`) — **not** a cool-knob grid; distinct from standalone EPU/TPU §18 |
