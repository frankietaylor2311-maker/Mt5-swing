...
| VIX risk gate | **boarded §72 / §73** | Menkhoff-style global vol risk-off on soft_ew_macro5 (§72) and IR3M carry (§73; primary carry_low_vix; fixed z≥1 → scale 0.35) |
| GPR risk gate | **boarded §72 / §73** | Caldara–Iacoviello / Liu–Zhang geo risk-off on soft_ew_macro5 (§72) and IR3M carry (§73; cool z≥1 for §71/§72 symmetry; lit often 1.5) |
| VIX+GPR stack | **boarded §72 / §73** | Sequential VIX then GPR cool on soft (`soft_vix_gpr_stack`) and carry (`carry_vix_gpr_stack`) — **not** a cool-knob grid |
