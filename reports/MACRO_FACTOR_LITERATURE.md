...
| VIX risk gate | **boarded §72** | Menkhoff-style global vol risk-off on soft_ew_macro5 (fixed z≥1 → scale 0.35; primary soft_low_vix) |
| GPR risk gate | **boarded §72** | Caldara–Iacoviello / Liu–Zhang geo risk-off on soft_ew_macro5 (this wave cool z≥1 for §71 symmetry; lit often 1.5) |
| VIX+GPR stack | **boarded §72** | Sequential VIX then GPR cool on soft returns (`soft_vix_gpr_stack`) — **not** a cool-knob grid |
...
8b. **Du, Keerati & Schreger (2025)** — *Decoupling Dollar and Treasury Privilege* — public gov-bond CIP + U.S. Treasury Premium panel (`cip_dataset_v4`); boarded as scholarly FX wave **§67**; CIP-conditioned Lustig–Verdelhan carry boarded **§68**; soft-stack CIP enrichment boarded **§69**; CIP-conditioned soft EW boarded **§71**; VIX/GPR-conditioned soft EW boarded **§72**.
