...
8b. **Du, Keerati & Schreger (2025)** — *Decoupling Dollar and Treasury Privilege* — public gov-bond CIP + U.S. Treasury Premium panel (`cip_dataset_v4`); boarded as scholarly FX wave **§67**; CIP-conditioned Lustig–Verdelhan carry boarded **§68**; soft-stack CIP enrichment boarded **§69**; CIP-conditioned soft EW boarded **§71**.
