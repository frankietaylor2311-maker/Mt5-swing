...
8. **Du, Tepper & Verdelhan (2018), JF** — CIP deviations / intermediary constraints (funding stress) — future work with cross-currency basis data.
...
| Multi-country CPI / PPI / IP / retail / unemployment / wages / LFP / employment-rate / real GDP / construction / passenger-car regs / merchandise export-value / merchandise import-value | Dahlquist economic momentum | **Mostly boarded** — IP §42 / retail §46 / employment §41 (persons) / PPI §51 / CPI §52 / **UR §54** / **wage/earnings §55** / **LFP/activity §56** / **employment-rate §57** / **real GDP growth §58** / **construction-production §59** / **passenger-car regs §60** / **merchandise export-value §61** / **merchandise import-value §62** (XTIMVA01*M657S YoY; EUR=DEM Germany proxy; full G10; unit=VALUE not volume; mirrors export §61; CIP/basis Missing + hours/vacancies thin + PRSVTT*/ODMN* 404 fall-through; promote=0). PPI STALE ~2022-12; CPI JPY STALE ~2021-06. Building-permits §43 distinct (leading flow). Capital-sleeve mix §53 boarded (promote=0). |
