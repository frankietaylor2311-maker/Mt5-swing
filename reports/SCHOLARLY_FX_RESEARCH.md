...
**Next structure (if promote=0):** Done as §51 (OECD PPI / PIEAMP). FX IV/RR + news-sentiment still **blocked**. Next: **FTMO MT5 CSV re-score** when exports arrive.
