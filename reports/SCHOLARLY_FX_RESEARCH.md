...
20. Next scholarly candidates (not sleeve coolers): **FTMO MT5 CSV re-score** when exports arrive (all boards still `approximate_non_ftmo`; `data/ftmo/` empty except README); FX IV/RR **blocked**; news-based currency sentiment still blocked without free multi-year panel. (**Construction-production §59 done**; Real GDP growth §58 / Employment-rate §57 / LFP/activity §56 / Wage/earnings §55 / Unemployment-rate §54 / Capital-sleeve mix §53 / OECD CPI §52 / PPI §51 / capacity-utilization §50 / labour-productivity §49 / ULC §48 / BIS DSR §47 / Retail-sales §46 / Country-GPR bilateral §45 / ACM TP §44 / Building-permits §43 / Industrial-production §42 / Employment §41 / WUI §40 / BCI §39 / CCI §38 / CLI §37 done.) Free scholarly queue **thinning** — dedicated UR + LCEAMN wage + LFP/activity + employment-rate + real-GDP-growth + construction-production gaps closed; credit-impulse already §32 companion (`credit_chg_xs`) — skip as primary. IMF IFS trade unit-value ToT **404** on FRED.
...
**Next structure (if promote=0):** FX IV/RR + news-sentiment still **blocked**. Free scholarly queue **thinning** (UR + LCEAMN wage + LFP/activity + employment-rate + real-GDP-growth + construction-production gaps closed; credit-impulse already §32 companion — skip). Next: **FTMO MT5 CSV re-score** when exports arrive (`data/ftmo/` empty except README), or free OECD **housing starts / completions** if distinct from permits §43, or **orders / inventories** if live on FRED. No go-live claim under `approximate_non_ftmo`.
