...
**Status:** Active (2026-09-24 BST, **VIX/GPR-conditioned Rogoff PPP / real-FX value §75 boarded** (value × VIX/GPR gate/cool; soft=0 hard=0 promote=0) after VIX/GPR-conditioned Menkhoff FX momentum §74 boarded (Menkhoff mom × VIX/GPR gate/cool; soft=0 hard=0 promote=0) after VIX/GPR-conditioned Lustig–Verdelhan carry §73 boarded (IR3M carry × VIX/GPR gate/cool; soft=0 hard=0 promote=0) after VIX/GPR-conditioned soft EW §72 boarded (soft_ew_macro5 × VIX/GPR gate/cool; soft=8 hard=8 promote=0) after CIP-conditioned soft EW §71 boarded; free scholarly single-series + CIP XS + CIP×carry + soft-stack CIP + CIP-conditioned soft + VIX/GPR-conditioned soft + VIX/GPR-conditioned carry + VIX/GPR-conditioned mom boarded; FX IV/RR + news-sentiment still blocked). Replaces the technical **overlay hunt** as the primary path toward FTMO-consistent ~1%/month.. Replaces the technical **overlay hunt** as the primary path toward FTMO-consistent ~1%/month.
