...
**Next structure (if promote=0):** FX IV/RR + news-sentiment still **blocked**. Next free candidate: **FTMO MT5 CSV re-score** when exports arrive (`data/ftmo/` empty except README) — *not* another locked-sleeve cooler. Optional free: **OECD PPI / producer-price differentials** (MEI PPI YoY XS — inflation-cost channel distinct from ULC/CU/LP) or **credit impulse** = Δ12 of private credit/GDP (flow refresh of §32; skip as primary — companion already boarded).
