...
| 8 | USDCAD | H4 | hybrid_regime | 0.08% | 0.27 | 73 | YES | `approximate_non_ftmo` |
| 9 | USDJPY | H4 | mean_reversion_regime | -0.06% | -0.24 | 28 | YES | `approximate_non_ftmo` |
| 10 | USDCAD | H4 | breakout_donchian | -0.07% | -0.21 | 59 | YES | `approximate_non_ftmo` |
| 11 | AUDUSD | D1 | bbands_reversion | -0.10% | 0.50 | 37 | YES | `approximate_non_ftmo` |
| 12 | AUDUSD | D1 | trend_ma_adx | -0.10% | -0.45 | 81 | YES | `approximate_non_ftmo` |
